    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 mt-4 mt-lg-0 listing-detail-page">
        <div class="mt-4">
          ...
          <p><strong>1. Definition of Confidential Information</strong><br/>
            (a) For purposes of this Agreement, "<strong>Confidential Information</strong>" means any data or information that is proprietary to the Disclosing Party and not generally known to the public, whether in tangible or intangible form, <u>in whatever medium provided, whether unmodified or modified by Receiving Party or its Representatives (as defined herein), </u>whenever and however disclosed, including, but not limited to: (i) any marketing strategies, plans, financial information, names of clients or projections, operations, sales estimates, business plans and performance results relating to the past, present or future business activities of such party, its affiliates, subsidiaries and affiliated companies; (ii) plans for products or services, and customer or supplier lists; (iii) any scientific or technical information, invention, design, process, procedure, formula, improvement, technology or method; (iv) any concepts, reports, data, know-how, works-in-progress, designs, development tools, specifications, computer software, source code, object code, flow charts, databases, inventions, information and trade secrets; (v) any other information that should reasonably be recognized as confidential information of the Disclosing Party<u>; and (vi) any information generated by the Receiving Party or by its Representatives that contains, reflects, or is derived from any of the foregoing</u><strong>. </strong>Confidential Information need not be novel, unique, patentable, copyright-able or constitute a trade secret in order to be designated Confidential Information. The Receiving Party acknowledges that the Confidential Information is proprietary to the Disclosing Party, has been developed and obtained through great efforts by the Disclosing Party and that Disclosing Party regards all of its Confidential Information as trade secrets.</p>
          ...
          <p>(b) The validity, construction and performance of this Agreement shall be governed and construed in accordance with the laws of State of UP, India applicable to contracts made and to be wholly performed within such state, without giving effect to any conflict of laws provisions thereof. The Federal and state courts located in Uttar Pradesh India shall have sole and exclusive jurisdiction over any disputes arising under<u>, or in any way connected with or related to,</u><strong> </strong>the terms of this Agreement<strong> </strong><u>and Receiving Party: (i) consents to personal jurisdiction therein; and (ii) waives the right to raise </u><u><em>forum non conveniens</em></u><u> or any similar objection.</u><u><strong> </strong></u></p>
