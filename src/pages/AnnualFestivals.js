...
function AnnualFestivals ()  {
  ...
  function getMetaSingle() {
   ...
   const url = Mainurl + 'api/enquiry/pagemeta/31';
      ...
      <div class="col-lg-9">
        <div class="d-sm-flex d-block align-items-center">
          <div class="ml-0 mt-3 mt-sm-0">
            <h3 class="text-white mb-2"> Annual Festivals </h3>
            <div class="d-md-flex d-block"> 
              <span class="d-inline-block ml-md-3 ml-0 text-white">Interesting info Annual Festivals</span> </div>
          </div>
        </div>
      </div>
            ...
            <div class="row mb-4 dsts">
              <div class="col-12">
                <div class="section-title">
                  ...
                  <div class="sub-title text-right"> <span> Interesting info Annual Festivals</span></div>
                </div>
              </div>
...
export default AnnualFestivals;
