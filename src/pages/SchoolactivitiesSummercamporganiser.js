...
function SchoolactivitiesSummercamporganiser ()  {
  ...
  function getMetaSingle() {
   ...
   const url = Mainurl + 'api/enquiry/pagemeta/42';
      ...
      <div class="col-lg-9">
        <div class="d-sm-flex d-block align-items-center">
          <div class="ml-0 mt-3 mt-sm-0">
            <h3 class="text-white mb-2"> School activities and Summer camp organiser </h3>
            <div class="d-md-flex d-block"> 
              <span class="d-inline-block ml-md-3 ml-0 text-white">Interesting info School activities and Summer camp organiser</span> </div>
          </div>
        </div>
      </div>
            ...
            <div class="row mb-4">
              <div class="col-12">
                <div class="section-title">
                  ...
                  <div class="sub-title text-right"> <span> Interesting info School activities and Summer camp organiser</span></div>
                </div>
              </div>
              <div class="col-md-12">
...
export default SchoolactivitiesSummercamporganiser;
