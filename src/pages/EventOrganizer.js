...
function EventOrganizer ()  {
  ...
  function getMetaSingle() {
   ...
   const url = Mainurl + 'api/enquiry/pagemeta/35';
      ...
      <div class="col-lg-9">
        <div class="d-sm-flex d-block align-items-center">
          <div class="ml-0 mt-3 mt-sm-0">
            <h3 class="text-white mb-2"> Event Organizer </h3>
            <div class="d-md-flex d-block"> 
              <span class="d-inline-block ml-md-3 ml-0 text-white">Interesting info Event Organizer</span> </div>
          </div>
        </div>
      </div>
            ...
            <div class="row mb-4 dsts">
              <div class="col-12">
                <div class="section-title">
                  ...
                  <div class="sub-title text-right"> <span> Interesting info Event Organizer</span></div>
                </div>
              </div>
