...
function ArtistmanagementInnerPage ()  {
  ...
  function getMetaSingle() {
   ...
   const url = Mainurl + 'api/enquiry/pagemeta/48';
            ...
            <div class="row mb-4 dsts">
              <div class="col-12">
                <div class="section-title">
                  ...
                  <div class="sub-title text-right"> <span> Interesting info Artist Management</span></div>
                </div>
              </div>
              <div class="col-md-12">
...
export default ArtistmanagementInnerPage;
